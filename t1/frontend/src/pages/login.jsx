...
export default function AuthPage() {
  ...
  return (
    <ThemeProvider theme={theme} >
      ...
      <Box sx={{ background: "linear-gradient(to bottom, #000000, #434343)", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", pt: { xs: 8, md: 10 }, pb: { xs: 2, md: 6 } }}>
        
        <Container component="main" maxWidth="md">
          <Paper elevation={3} sx={{ p: { xs: 2, md: 3 }, borderRadius: 2, backdropFilter: "blur(10px)", backgroundColor: "rgba(28, 27, 31, 0.8)", boxShadow: "0 0 20px   #F45558" }}>
